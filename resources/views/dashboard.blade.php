...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="card rounded-0 bg-light position-relative">
                <div class="card-body">
                    <h3 class="font-bold">{{ $ftp_count }}</h3>
                    <p class="m-0">FTP Users</p>
                </div>
                <div class="position-absolute bottom-0 end-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" class="m-3 opacity-25" viewBox="0 0 16 16">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="card rounded-0 bg-light position-relative">
                <div class="card-body">
                    <h3 class="font-bold">{{ $storage_usage }}%</h3>
                    <p class="m-0">used of {{ $total_storage }} total</p>
                </div>
                <div class="position-absolute bottom-0 end-0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" class="m-3 opacity-25" viewBox="0 0 16 16">
