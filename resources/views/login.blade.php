...
<main class="form-signin w-100 m-auto">
    <form method="POST" action="/login">
        <img class="my-4" src="/lumic.svg" alt="" height="32">
        <h1 class="h3 mb-3 fw-normal">Please sign in</h1>

        <div class="form-floating">
            <input type="text" name="name" class="form-control rounded-0" id="floatingInput" placeholder="name@example.com">
        ...
        <button class="btn btn-primary w-100 py-2 rounded-0" type="submit">Sign in</button>
        <p class="mt-3 text-body-secondary">&copy; 2017–2023</p>
