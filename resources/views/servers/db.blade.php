        ...
        <div class="card rounded-0">
            <div class="card-body">
                ...
                <form method="post" action="/servers/{{ $server->id }}/db" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md">
                            <input class="form-control form-control-sm rounded-0" name="name" type="text" placeholder="Database name">
                        </div>
                        ...
                        <div class="col-md">
                            <input class="form-control form-control-sm rounded-0" name="password" type="text" placeholder="Password">
                        </div>

                        <div class="col-md-auto">
                            <button type="submit" class="btn btn-sm btn-primary mb-3 rounded-0">Create database</button>
                        </div>
                    </div>
                </form>
